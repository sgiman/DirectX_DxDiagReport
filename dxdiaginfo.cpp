//********************************************************************************
// File: dxdiaginfo.cpp (x86/x64) - windows
//
...
HRESULT CDxDiagInfo::QueryDxDiagViaDll()
{
    ...
    GetSystemDevices( m_vSystemDevices );					// SystemDevices		

    GetDirectXFilesInfo( &m_pFileInfo );					// FilesInfo

    GetDisplayInfo( m_vDisplayInfo );						// DisplayInfo

    GetSoundInfo( m_vSoundInfos, m_vSoundCaptureInfos );	// SoundInfo

    GetMusicInfo( &m_pMusicInfo );							// MusicInfo

    GetInputInfo( &m_pInputInfo );							// InputInfo

    GetNetworkInfo( &m_pNetInfo );							// NetworkInfo

    GetShowInfo( &m_pShowInfo );							// ShowInfo

    GetLogicalDiskInfo( m_vLogicalDiskList );				// LogicalDiskInf
...
// Desc: (9) Gather DXVA Deinterlace Caps
//-----------------------------------------------------------------------------
...
HRESULT CDxDiagInfo::GetInputInfo( InputInfo** ppInputInfo )
{
    ...
    *ppInputInfo = pInputInfo;
    ...
    // "DxDiag_DirectInput.DxDiag_DirectInputGameports"
